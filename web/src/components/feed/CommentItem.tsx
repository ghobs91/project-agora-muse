      ...
      <div className="py-3">
        ...
        <div className="flex items-center gap-2 mb-1.5">
          <button
            ...
            className="shrink-0 w-5 h-5 rounded-full bg-surface-lighter flex items-center justify-center text-text-500 hover:text-text-300 transition-colors"
          ...
          <span className="text-xs text-text-500" suppressHydrationWarning>{timeAgo}</span>
        </div>
        ...
        {!collapsed && (
          <>
            ...
            <div className="flex items-center gap-1.5 ml-7">
              <button
                ...
                className={`flex items-center gap-1 px-2 py-0.5 rounded-full transition-colors text-xs font-medium ${
                  isUpvoted
                    ...
                    : 'bg-surface-lighter text-text-500 hover:text-sky-400'
                }`}
              ...
              <span className="flex items-center gap-1 px-2 py-0.5 rounded-full bg-surface-lighter text-text-600 text-xs">
              ...
              {!isDeep && (
                <button
                  ...
                  className="flex items-center gap-1 px-2 py-0.5 rounded-full text-text-500 hover:text-sky-400 transition-colors text-xs font-medium"
                >
                  <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            {replying && (
              <form onSubmit={handleSubmitReply} className="ml-7 mt-2">
                <textarea
                  ...
                  rows={2}
                  maxLength={3000}
                  className="w-full text-sm bg-surface-lighter rounded-lg px-3 py-2 border border-dark-700/50 resize-none focus:outline-none focus:border-sky-500 placeholder:text-text-600 text-text-200"
                  autoFocus
                />
